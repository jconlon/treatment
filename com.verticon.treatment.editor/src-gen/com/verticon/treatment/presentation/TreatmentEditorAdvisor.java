...
import com.verticon.treatment.presentation.TreatmentEditorPlugin;
 ...
 * @generated
 */
public final class TreatmentEditorAdvisor extends WorkbenchAdvisor
{
  /**
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  private static final String[] FILE_EXTENSION_FILTERS = TreatmentEditor.FILE_EXTENSION_FILTERS.toArray(new String[0]); 

  	/**
	 * Added to support Navigator
	 * 
  ...
  {
		return TreatmentEditorPlugin.INSTANCE.getString(key);
	}
  ...
  {
		return com.verticon.treatment.presentation.TreatmentEditorPlugin.INSTANCE.getString(key, new Object [] { s1 });
	}
  ...
  public static class Application implements IApplication
  {
    ...
    {
			WorkbenchAdvisor workbenchAdvisor = new TreatmentEditorAdvisor();
	...
	public void createInitialLayout(IPageLayout layout)
    {
      ...
      layout.addPerspectiveShortcut(ID_PERSPECTIVE);
			...
			IViewLayout viewLayout = layout
					.getViewLayout("org.eclipse.ui.views.ResourceNavigator");
			...
			layout.addView(IPageLayout.ID_PROP_SHEET, IPageLayout.RIGHT,
					(float) 0.55, layout.getEditorArea());
  ...
  /**
	 * Open action for the objects from the Treatment model.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @generated
	 */
  ...
  /**
	 * Open URI action for the objects from the Treatment model.
	 * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
	 * @generated
	 */
