...
/**
 * This is an example of a Treatment model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
  ...
  implements IEditingDomainProvider, ISelectionProvider, IMenuListener, IViewerProvider
{
			...
			public void partActivated(IWorkbenchPart p) {
				if (p instanceof ContentOutline) {
					if (((ContentOutline)p).getCurrentPage() == contentOutlinePage) {
						getActionBarContributor().setActiveEditor(TreatmentEditor.this);
				...
				else if (p == TreatmentEditor.this) {
					handleActivate();
				}
			}
  ...
  protected void initializeEditingDomain()
  {
		...
		adapterFactory.addAdapterFactory(new TreatmentItemProviderAdapterFactory());
		...
		PropertySheetPage propertySheetPage =
			new ExtendedPropertySheetPage(editingDomain) {
				...
				public void setSelectionToViewer(List<?> selection) {
					TreatmentEditor.this.setSelectionToViewer(selection);
					TreatmentEditor.this.setFocus();
				}
...
public void setSelection(ISelection selection)
  ...
  {
		return TreatmentEditorPlugin.INSTANCE.getString(key, new Object [] { s1 });
	}
