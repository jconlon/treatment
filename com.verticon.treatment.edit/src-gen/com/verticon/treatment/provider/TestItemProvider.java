...
/**
 * This is the item provider adapter for a {@link com.verticon.treatment.Test} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
  ...
  extends EventItemProvider
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Test_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Test_value_feature", "_UI_Test_type"),
				 TreatmentPackage.Literals.TEST__VALUE,
				 true,
				 false,
				 false,
  ...
  {
		Date labelValue = ((Test)object).getDate();
  ...
  public void notifyChanged(Notification notification)
  {
		...
		switch (notification.getFeatureID(Test.class)) {
			case TreatmentPackage.TEST__VALUE:
