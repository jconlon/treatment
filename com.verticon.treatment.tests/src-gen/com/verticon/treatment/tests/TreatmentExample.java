...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>treatment</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class TreatmentExample
{
  ...
  public static void main(String[] args)
  {
    ...
    resourceSet.getPackageRegistry().put
      (TreatmentPackage.eNS_URI, 
       TreatmentPackage.eINSTANCE);
    ...
    if (args.length == 0)
    {
      ...
      try
      {
        Resource resource = resourceSet.createResource(URI.createURI("http:///My.treatment"));
        Program root = TreatmentFactory.eINSTANCE.createProgram();
